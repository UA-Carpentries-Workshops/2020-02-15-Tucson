...
address: "Please check your email"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
instructor: ["Drake Asberry", "Nathalia Graf Gachet", "Uwe Hilgert", "Blake Joyce"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Ryan Bartelme", "Alex Bigelow", "Gustavo de Oliveira Almeida", "Noah Giebink", "Fayu Jiang", "Artin Majdi", "Albert Reiber", "Zhixue Shu", "Heidi Steiner", "Travis Struck", "Isabella Viney", "Jeremy Weiss", "Derrick Yoo"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
